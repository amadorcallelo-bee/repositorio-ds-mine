...
Con el entorno único del repositorio (`requirements.txt` de la raíz, que ya incluye las
dependencias del C-2; durante el desarrollo vivió en un `.venv-rag` aparte mientras el A-2
corría en paralelo, y se consolidó al integrar):
